...
static ID3D11Buffer* g_pVSConstantBuffer1 = nullptr; // 定数バッファ b0
static ID3D11Buffer* g_pVSConstantBuffer2 = nullptr; // 定数バッファ b0
static ID3D11Buffer* g_pVSConstantBuffer3 = nullptr; // 定数バッファ b3
static ID3D11Buffer* g_pPSConstantBuffer0 = nullptr; // ピクセルシェーダの定数バッファ b0
